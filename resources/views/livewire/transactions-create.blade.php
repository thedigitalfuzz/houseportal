        ...
        <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div class="bg-white p-6 rounded shadow-lg w-96">
                ...
                <div class="space-y-2">
                    ...
                    <input type="number" wire:model="deposit" class="border rounded w-full px-2 py-1" placeholder="Deposit">
                    <textarea wire:model="notes" class="border rounded w-full px-2 py-1" placeholder="Notes"></textarea>
                </div>

                <!-- BUTTONS -->
                <div class="flex justify-end gap-2 mt-4">
                    <button wire:click="closeModal" class="px-4 py-2 bg-gray-500 text-white rounded">
                        Cancel
                    </button>
