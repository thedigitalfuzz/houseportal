<div>
    <div class="flex justify-between items-center mb-4">
        <h2 class="text-xl font-bold">Game Points</h2>
        <div class="flex gap-2">
            ...
            <button wire:click="openRechargeListModal" class="px-4 py-2 bg-blue-600 text-white rounded ml-2">Recharge List</button>
